...
namespace VideoDL_m3u8
{
    public class VideoDL : BaseDL
    {
        ...
        /// <param name="muxOutputFormat">Set video muxing output format.</param>
        ...
        public virtual async Task DownloadAsync(
            ...
            MuxOutputFormat muxOutputFormat = MuxOutputFormat.MP4,
            ...
            CancellationToken token = default)
        {
            ...
            if (isM3U8 || isMPD)
            {
                ...
                if (isMPD)
                {
                    ...
                    var period = mpd.Periods.FirstOrDefault();
                    if (period == null)
