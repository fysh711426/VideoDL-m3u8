...
{
    // Refer to: https://github.com/samuelneff/MimeTypeMap
    internal static class MimeTypeMap
    {
        public static string GetExtension(string mimeType)
        {
            var ext = "";
            if (dictionary.Value.TryGetValue(mimeType, out var sExt))
                ext = sExt;
            return ext;
        }

        public static Lazy<Dictionary<string, string>> dictionary = new(() =>
        {
